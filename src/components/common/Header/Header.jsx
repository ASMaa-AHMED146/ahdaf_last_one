...
//         <nav className='hidden lg:block'>
//             <ul className='lg:flex text-white gap-[30px] px-[10px] border-[1px] border-[#8F8F8FF0] rounded-[20px] py-[5px] font-syne'>
//                 <NavLink to={'/'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })}>
//                     {t('header.home')}
//                 </NavLink>
//                 <NavLink to={'/services'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })}>
//                     {t('header.services')}
//                 </NavLink>
//                 <NavLink to={'/packages'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })}>
//                     {t('header.packages')}
//                 </NavLink>
//                 <NavLink to={'/offers'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })}>
//                     {t('header.offers')}
//                 </NavLink>
//                 <NavLink to={'/aboutus'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })}>
//                     {t('header.aboutUs')}
//                 </NavLink>
//                 <NavLink to={'/callus'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })}>
//                     {t('header.contactUs')}
//                 </NavLink>
//                 <NavLink to={'/blog'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })}>
//                     {t('header.blog')}
//                 </NavLink>
//             </ul>
//         </nav>
...
//                             alt={isArabic ? 'Egypt flag' : 'UK flag'} 
//                             className='max-w-[30px] max-h-[30px] rounded-[50%]' 
//                         />
...
//                             <ul className='absolute top-[150%] right-0 text p-[10px] z-30 bg-[#f36b35c5] rounded-[5px]'>
//                                 <li 
//                                     className={`hover:text-white cursor-pointer ${isArabic ? 'text-white font-bold' : ''}`}
...
//                 {isopen && (
//                     <div className='bg-[#1A7474] top-[40px] list-none text-[white] items-start flex flex-col gap-[10px] pr-[50px]'>
//                         <NavLink to={'/'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.home')}
//                         </NavLink>
//                         <NavLink to={'/services'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.services')}
//                         </NavLink>
//                         <NavLink to={'/packages'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.packages')}
//                         </NavLink>
//                         <NavLink to={'/offers'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.offers')}
//                         </NavLink>
//                         <NavLink to={'/aboutus'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.aboutUs')}
//                         </NavLink>
//                         <NavLink to={'/callus'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.contactUs')}
//                         </NavLink>
//                         <NavLink to={'/blog'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.blog')}
//                         </NavLink>
...
//                                     src={isArabic ? EgyptFlag : UKFlag} 
//                                     alt={isArabic ? 'Egypt flag' : 'UK flag'} 
//                                     className='max-w-[20px] max-h-[20px] rounded-[50%]' 
//                                 />
//                                 {isArabic ? 'العربية' : 'English'}
//                             </p>
//                             {langMenuOpen && (
//                                 <ul className='absolute right-[-60px] top-[10px] text p-[10px] z-30 bg-[#f36b35c5] rounded-[5px]'>
//                                     <li 
//                                         className={`hover:text-white cursor-pointer ${isArabic ? 'text-white font-bold' : 'text-[#1A7474]'}`}
//                                         onClick={() => handleLanguageChange('ar')}
//                                     >
//                                         العربية
//                                     </li>
...
//                         <NavLink to={'/auth'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.login')}
//                         </NavLink>
//                         <NavLink to={'/auth/login'} style={({ isActive }) => ({ color: isActive ? 'white' : '#D0D0D0' })} onClick={closeAllMenus}>
//                             {t('header.signUp')}
//                         </NavLink>
//                     </div>
//                 )}
