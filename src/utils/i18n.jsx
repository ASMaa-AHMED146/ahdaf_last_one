  ...
  en: {
    translation: {
      ...
      aboutus: {
        ...
        title: 'Our Mission is to Provide High-Quality Service',
        subtitle1: 'Professional and Trained Staff',
        paragraph1: 'We have a highly trained team with extensive experience in cleaning and sterilization.',
        subtitle2: 'Latest Technologies and Equipment',
        paragraph2: 'We use the latest equipment and materials to ensure effective and safe cleaning.',
        subtitle3: 'Guaranteed Satisfaction',
        paragraph3: 'We offer a 100% satisfaction guarantee for all our services.',
      },
      packagesDetails: {
        packages: 'Packages',
        loading: 'Loading...',
      ...
      callus: {
        ...
        contactDescription:
          'Do you have any inquiries or need assistance? Our team is ready to serve you around the clock. Contact us now, and we will respond as soon as possible!',
        addressTitle: 'Address:',
        address: '15 Al Barsha 1 Street, Dubai, United Arab Emirates',
        phoneTitle: 'Phone Number:',
        phone: '01090009330 / 00971551310922',
        emailTitle: 'Email:',
        email: 'info@dubai-hotel-service.com',
  ...
  ar: {
    translation: {
      ...
      aboutus: {
        ...
        title: 'مهمتنا هي تقديم خدمة عالية الجودة',
        subtitle1: 'فريق عمل محترف ومدرب',
        paragraph1: 'لدينا فريق مدرب تدريبًا عاليًا ولديه خبرة واسعة في التنظيف والتعقيم.',
        subtitle2: 'أحدث التقنيات والمعدات',
        paragraph2: 'نستخدم أحدث المعدات والمواد لضمان تنظيف فعال وآمن.',
        subtitle3: 'ضمان الرضا',
        paragraph3: 'نقدم ضمان رضا 100% على جميع خدماتنا.',
      },
      packagesDetails: {
        packages: 'الباقات',
        loading: 'جارٍ التحميل...',
      ...
      callus: {
        ...
        contactDescription:
          'هل لديك أي استفسار أو تحتاج إلى مساعدة؟ فريقنا جاهز لخدمتك على مدار الساعة. تواصل معنا الآن وسنرد عليك في أسرع وقت ممكن!',
        addressTitle: 'العنوان:',
        address: '15 شارع البرشاء 1 دبي، الإمارات العربية المتحدة',
