...
export default function Createnewaccount() {
  ...
  return (
    <div>
      <Main>
        <div className="md:pr-[40px] pr-[20px] overflow-auto max-h-full">
          <div className="">
            <img src={Logo} alt="" className="h-[80px]" />
          </div>
          <div>
            <h1 className="text-[#2D2D2D] font-[700] text-[25px]  ">انشاء حساب جديد!</h1>
            <p className="text-[#707070] font-[500] text-[17px]">
              أنشئ حسابك الآن واستمتع بالوصول السريع إلى جميع خدماتنا. فقط أدخل بياناتك الأساسية وابدأ تجربتك بكل سهولة!
            </p>
          </div>
          ...
          <p className="text-center">
            لديك حساب بالفعل ؟{" "}
            <span
              className="text-[#F36C35] font-[500] text-[20px] cursor-pointer"
              onClick={() => nav("/auth")}
            >
              تسجيل الدخول
            </span>
